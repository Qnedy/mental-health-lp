...
import { Environment, Float, Scroll, ScrollControls, Sparkles, PositionalAudio } from '@react-three/drei';
import './App.css';
  ...
  return (
    <>
      <EffectComposer>
        ...
        <Bloom intensity={1} luminanceThreshold={0.1} luminanceSmoothing={0.9} height={1000} />
      ...
      <ScrollControls pages={6} damping={0.25}>
        <Scroll>
         {/* top */}
          ...
          >
            ...
            <Butterfly scale={1} position={[-10,-3,-6]}/>
            <Butterfly scale={1} position={[10,-4,-10]}/> 
          </Float>
          ...
          floatingRange={[1, 1]}
          >
            <Butterfly scale={1} position={[-1,-12.5,0]}/>
            <Butterfly scale={1} position={[12,-14,-10]}/> 
          </Float>
          ...
          <Float
            ...
            floatingRange={[1, 1]}
          >
            <Butterfly scale={1} position={[-3,-19.5,2]}/>
            <Butterfly scale={1} position={[4,-24,2]}/>  
          </Float> 

          <Sparkles noise={0} count={400} speed={0.01} size={0.6} color={"#FFD2BE"} opacity={10} scale={[20,100,20]}></Sparkles>
        ...
        <Scroll html style={{ width: '100%' }}>
          <Container style={{ position: 'relative' }}>
            <Row className='text-center align-items-center justify-content-center' style={{ position: 'absolute', width: '100%', height: '100vh', padding: '8px 30px' }}>
              <Col xs={6}>
                <div>
                  <h1 style={{ marginBottom: '0px', color: '#fff' }}>Life can be a struggle</h1>
                </div>
              </Col>
            </Row>

            <Row className='text-center align-items-center justify-content-center' style={{ position: 'absolute', width: '100%', height: '100vh', padding: '8px 30px 0px', top: '100vh' }}>
              <Col xs={6}>
                <div>
                  <h1 style={{ marginBottom: '0px', color: '#fff' }}>Sometimes you can feel</h1>
                </div>
              </Col>
            </Row>
            ...
            <Row className='text-center align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '100vh', padding: '0px 30px 0px',top: '200vh'}}>
              <Col xs={6}>
                  <div>
                    ...
                    <h1 style={{marginBottom: '0px', color: '#fff'}}>Overwhelmed</h1>
                    <h1 style={{marginBottom: '0px', color: '#fff'}}>Empty inside</h1>
                  </div>
              </Col>
            </Row> 
            ...
            <Row className='text-center align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '100vh', padding: '0px 30px 0px',top: '300vh'}}>
              <Col xs={6}>
                  <div>
                    <h1 style={{marginBottom: '0px', color: '#fff' }}>Drifting through life <br />With no help or guidance</h1>
                  </div>
              </Col>
            </Row> 
            ...
            <Row className='text-center align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '100vh', padding: '0px 30px 0px',top: '400vh'}}>
              <Col xs={8}>
                  <div>
                    <h1 style={{marginBottom: '0px', color: '#fff' }}>But there is hope...<br/> and people who can help</h1>
                  </div>
              </Col>
            </Row>  
            ...
            <Row className='text-center align-items-center justify-content-center' style={{position: 'absolute',width: '100%',height: '100vh', padding: '0px 30px 0px',top: '500vh'}}>
              <Col xs={6}>
                  <div>
                    ...
                    <h1 style={{marginBottom: '0px', color: '#fff'}}>It's time to get<br/> the support you need</h1>
                    <h2 style={{marginBottom: '30px', color: '#fff', marginTop: '-20px'}}>To get your life back</h2>
